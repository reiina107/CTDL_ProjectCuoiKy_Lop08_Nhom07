...
BOOL  PlotCirc(HDC hDC, HPEN hPen, COORD BGN, COORD END, int a, int b, int c);
...
void drawText(int x, int y, const char* mess) {
	...
	HPEN pen = CreatePen(PS_SOLID, 5, RGB(105, 105, 105));
	SelectObject(device_context, pen);
	SetTextColor(device_context, RGB(105, 105, 105));
...
BOOL PlotRect(HDC hDC, HPEN hPen, COORD BGN, COORD END)
{
	SelectObject(hDC, CreateSolidBrush(RGB(135, 206, 250)));
